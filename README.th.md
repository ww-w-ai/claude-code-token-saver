...
**เนื้อหาเดียวกัน ลดส่วนเสริม เปิดเป็นค่าเริ่มต้น**

SessionStart hook เดียวกันยังฉีดกฎสไตล์การตอบกลับที่ทำงานใน **ทุกเซสชันและทุกโมเดล** — ไม่ต้องใช้แฟล็ก ไม่ต้องตั้งค่า สามอย่างที่เปลี่ยน:

- **ตัดอารัมภบท** — ไม่มี "ขอตรวจสอบก่อน…", "ตอนนี้ฉันจะ…", การกล่าวคำถามซ้ำ หรือสรุปสิ่งที่ diff แสดงอยู่แล้ว
- **รูปแบบที่เหมาะกับเนื้อหา** — bullet สำหรับรายการ ร้อยแก้วสำหรับการให้เหตุผล (trade-off, สาเหตุ, เหตุผลสนับสนุน) ไม่บังคับฝ่ายใด
- **การแสดงออกที่กระชับขึ้น** — ประเด็นเดียวกัน คำน้อยลง ร้อยแก้วที่ชัดเจนกว่าคือร้อยแก้วที่สั้นกว่า

ขีดจำกัดที่เข้มงวด: ห้ามตัดเนื้อหา ห้ามข้ามการตรวจสอบ หรือบีบอัดความละเอียดอ่อนให้เหลือหนึ่งประโยค สาระยังคงครบถ้วน ลดเฉพาะบรรจุภัณฑ์
