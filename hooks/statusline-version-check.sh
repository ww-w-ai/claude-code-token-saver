...
# If settings.json statusLine points to an older cc-token-saver version,
...
if (!current.includes('cc-token-saver') || !current.endsWith('statusline-logger.sh')) process.exit(0);
